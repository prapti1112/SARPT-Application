                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 295,
                      child: TextFormField(
                        validator: (value) => (value.isEmpty || !(value.contains("@") && value.contains("."))) ?  "Enter a valid email" : null,
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () =>
                                setState(() => _isPasswordVisible[0] = !_isPasswordVisible[0]),
                          ),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10.0),
                          ),
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            icon: _isPasswordVisible[1]
                                ...
                                : Icon(Icons.visibility_off , color: Colors.green,),
                            onPressed: () =>
                                setState(() => _isPasswordVisible[1] = !_isPasswordVisible[1]),
                          ),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10.0),
                          ),
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () async {
                          if(_formKey.currentState.validate()) {
                            ...
                            dynamic result = await _auth.registerWithEmailAndPassword(_emailController.text, _password);
                            if(result == null) {
